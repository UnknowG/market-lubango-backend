...
class StoreAPITest(APITestCase):
    ...
    def test_create_store_as_seller(self):
        ...
        store_data = {"name": "Test Store", "description": "A test store"}
    ...
    def test_create_duplicate_store(self):
        ...
        url = reverse("create_store")
        store_data = {"name": "Another Store", "description": "Another test store"}
        response = self.client.post(url, store_data, format="json")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_update_store(self):
        ...
        url = reverse("manage_store")
        update_data = {"name": "Updated Store", "description": "An updated test store"}
